...
void udf::frame_size_calculator::do_address_node(udf::address_node *const node, int lvl) {
  // EMPTY
}
...
void udf::frame_size_calculator::do_unless_node(udf::unless_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  _localsize += 4;
}

void udf::frame_size_calculator::do_process_node(udf::process_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  _localsize += 4;
}
...
void udf::frame_size_calculator::do_tensor_index_node(udf::tensor_index_node * const node, int lvl) {
  // EMPTY
}
